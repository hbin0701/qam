#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V4 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=SINGLE_QAM_EDIT_ONLINE_V4.10_Seed10001 \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v4,single,online \
    --seed=10001 \
