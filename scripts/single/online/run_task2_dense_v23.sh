#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V23 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=0220_qam_v23_random_re_v3 \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v23,single,online \
    --seed=10001 \
    ...
    --sparse=False \
    --dense_reward_version=v23 \
    --v23_step_penalty=0.0 \
    --terminal_bonus=20 \
