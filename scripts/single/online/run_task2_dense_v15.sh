#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V15 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=0220_qam_v15_random_newest_v2 \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v15,single,online \
    --seed=10001 \
