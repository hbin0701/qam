#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V10 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=SINGLE_QAM_EDIT_ONLINE_V10.10_Seed10001 \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v10,single,online \
    --seed=10001 \
