#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V20 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=0220_qam_v20_random_again \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v20,single,online \
    --seed=10001 \
