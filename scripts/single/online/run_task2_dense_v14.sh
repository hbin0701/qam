#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V14 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=0220_qam_v14_random \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v14,single,online \
    --seed=10001 \
