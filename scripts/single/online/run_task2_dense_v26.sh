#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V26 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=0223_qam_v26_cube_consistent_sampling_v1 \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v26,single,online \
    --seed=10001 \
