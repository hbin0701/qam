#!/bin/bash
# Run QAM-EDIT on Single-Play Task 2 with DENSE V21 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name=0220_qam_v21_random_re_v4 \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v21,single,online \
    --seed=10001 \
