#!/bin/bash
# Run QAM on Double-Play Task 2 with DENSE V1 reward (ONLINE-ONLY) from pretrained BC actor.
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Online, Pretrained] Double, V1, QAM" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v1,online,pretrained \
    --seed=10001 \
