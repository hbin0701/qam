#!/bin/bash
# Run QAM on Double-Play Task 2 with DENSE V1 reward (ONLINE-ONLY), using first 10k dataset samples.
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Online] Double, V1, QAM, DS-10k" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v1,online,dataset_10k \
    --seed=10001 \
