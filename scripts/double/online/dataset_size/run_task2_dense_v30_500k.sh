#!/bin/bash
# Run QAM on Double-Play Task 2 with DENSE V30 reward (ONLINE-ONLY), using first 500k dataset samples.
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Online] Double, V30, QAM, DS-500k" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v30,online,dataset_500k \
    --seed=10001 \
