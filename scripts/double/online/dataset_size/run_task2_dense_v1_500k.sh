#!/bin/bash
#SBATCH --job-name=qam_dbl_t2_v1_500k
...
#SBATCH --output=logs/slurm/double_online_ds500k_%j.out
#SBATCH --error=logs/slurm/double_online_ds500k_%j.err

# Run QAM on Double-Play Task 2 with DENSE V1 reward (ONLINE-ONLY), using first 500k dataset samples.
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Online] Double, V1, QAM, DS-500k" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v1,online,dataset_500k \
    --seed=10001 \
