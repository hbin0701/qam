#!/bin/bash
# Run QAM-EDIT on Double-Play Task 2 with DENSE V29 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Final, Online, NO Random Pos] Double, V29, QAM, Re" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v29,online \
    --seed=10001 \
