#!/bin/bash
# Run QAM-EDIT on Double-Play Task 2 with DENSE V24 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Final, Online, Random Pos] Double, V24, QAM, Again" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v24,online \
    --seed=10001 \
