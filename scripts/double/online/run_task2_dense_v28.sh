#!/bin/bash
# Run QAM-EDIT on Double-Play Task 2 with DENSE V28 reward (ONLINE-ONLY)
...
MUJOCO_GL=egl python main.py \
    ...
    --run_name="[Final, Online, NO Random Pos] Double, V28, QAM, Re" \
    --agent=agents/qam.py \
    --tags=QAM_EDIT,dense_v28,online \
    --seed=10001 \
